...
\begin{itemize}
    \item Pour HomeStrength: $S_{max} = \frac{n(n-1)(n+1)}{6}$. C'est la valeur maximale théorique de la nouvelle métrique HomeStrength, correspondant au cas où chaque joueur mieux classé reçoit à domicile chaque joueur moins bien classé.
