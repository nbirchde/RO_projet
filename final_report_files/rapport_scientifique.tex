...
\begin{itemize}
    ...
    \end{align*}
    \item \textbf{Max Deviation (MD) :} Pour $n$ joueurs réels sur $n_{eff}-1$ rondes, le nombre idéal de matchs à domicile est $\frac{n-1}{2}$. Les formules analytiques pour la moyenne et l'écart-type de l'écart maximal sont des approximations pour de grandes valeurs de $n$.
    \begin{align*}
        \mu_{MD} &\approx \frac{\sqrt{n-1}}{2} \sqrt{2 \ln n} \quad \text{si } n > 1, \text{ sinon } 0.0 \\
        \sigma_{MD} &\approx \frac{\sqrt{n-1}}{2} \frac{\pi}{\sqrt{6 \ln n}} \quad \text{si } n > 1, \text{ sinon } 1.0
    \end{align*}
\end{itemize}
