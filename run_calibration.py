...
# --- Configuration ---
N_PLAYERS = 6
ITERATIONS = 10000  # Iterations for each SA run
RUNS_PER_COMBINATION = 4 # Number of parallel SA chains for each (alpha, beta)
...
OUTPUT_CSV = "calibration_results_n6_empirical_norm_v4.csv" # New output file name
