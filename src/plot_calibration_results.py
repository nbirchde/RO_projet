...
# --- Configuration ---
INPUT_CSV = "calibration_results_n500_analytical_norm.csv" # Updated input file for analytical normalization
OUTPUT_DIR = "calibration_plots_n500_analytical_norm"      # Updated output directory for analytical normalization
...
# Objectives to minimize (using the scaled normalized scores)
...
if __name__ == "__main__":
    ...
    if not pareto_df.empty:
        ...
        pareto_df['sum_scaled_objectives'] = pareto_df[OBJECTIVES].sum(axis=1) # Use updated OBJECTIVES
